            ...
            <Grid container>
                    ...
                    <Grid item container xs={11} >
                        ...
                        <Container id="answer-container" className={classes.answerContainer}>
                            {show && <Typography id="answer-initial" className={classes.subheading} color="primary">A.&emsp;</Typography> }  
                            {show && 
                    ...
                    <Grid item container xs={1} justify='flex-end'>
                        <Button className={classes.save} disableRipple>
                            <BookmarkTwoToneIcon style={{fontSize: 60, position: 'absolute', top: '10px', right: '-7px'}}/>
                        </Button>
                    </Grid>
                            
                    {show ? <Button id="show-button" className={classes.showButton} color="primary" variant={"contained"} onClick={showAnswer}> Hide Answer</Button> :  <Button id="show-button" className={classes.showButton} color="primary" variant={"contained"} onClick={showAnswer}>Show Answer</Button>}
