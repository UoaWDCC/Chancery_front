...
function Flashcard() {
	...
	const [currentFlashcard, setCurrentFlashcard] = useState(displayedFlashcards[currentIndex]);
					...
					<React.Fragment>
						<Grid container justify="center">
							...
							<Grid item container xs={12} md={5} justify="flex-end" style={{ height: '40px' }}>
								<Typography className={classes.subheading} style={{ fontSize: 25, marginTop: 8 }}>
									Save&nbsp;
								</Typography>
